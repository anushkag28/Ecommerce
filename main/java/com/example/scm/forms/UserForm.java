...
public class UserForm {
    ...
    public @NotBlank(message = "Username is required") @Size(min = 3, message = "Min 3 Characters is required") String getName() {
        return name;
    }

    public void setName(@NotBlank(message = "Username is required") @Size(min = 3, message = "Min 3 Characters is required") String name) {
        this.name = name;
    }
    ...
    public void setAbout(@NotBlank(message = "About is required") String about) {
        this.about = about;
    }

    public @Size(min = 8, max = 12, message = "Invalid Phone Number") String getPhoneNumber() {
        return phoneNumber;
    }

    public void setPhoneNumber(@Size(min = 8, max = 12, message = "Invalid Phone Number") String phoneNumber) {
